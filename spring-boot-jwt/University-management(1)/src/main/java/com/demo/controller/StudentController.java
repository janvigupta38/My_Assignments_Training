...
public class StudentController {
	...
	@RequestMapping(value="/deletestudent/{phoneNumber}",method=RequestMethod.DELETE)
	@PreAuthorize("hasRole('admin')")
	public String DeleteStudent(@PathVariable("phoneNumber") String phoneNumber)
	{
		return studentService.DeleteStudent(phoneNumber);
	}
